// This is the solution for the leetcode problem, and it gives a TLE exception
// But the logic might be good

// Start a frontier with all positions of the starting character
// Based on the path length, search and re-insert into the frontier
